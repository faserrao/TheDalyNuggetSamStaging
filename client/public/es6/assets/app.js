...
function viewDisplayRandomNuggetImages()
{
  const NUM_OF_RADOM_NUGGET_IMAGE_FILES = 20;
  let   imageFileNum;

  imageFileNum = ((Math.ceil(Math.random() * 100)) % NUM_OF_RADOM_NUGGET_IMAGE_FILES) + 1;
  document.getElementById("random-nugget-image-a-id").src = "img/nuggimages/" + imageFileNum + "a.jpg";

  imageFileNum = ((Math.ceil(Math.random() * 100)) % NUM_OF_RADOM_NUGGET_IMAGE_FILES) + 1;
  document.getElementById("random-nugget-image-b-id").src = "img/nuggimages/" + imageFileNum + "b.jpg";

  imageFileNum = ((Math.ceil(Math.random() * 100)) % NUM_OF_RADOM_NUGGET_IMAGE_FILES) + 1;
  document.getElementById("random-nugget-image-c-id").src = "img/nuggimages/" + imageFileNum + "c.jpg";
}
...
function postTakeRiskNugget()
{
  console.log("Entering postTakeRiskNugget()");

  const client = apigClientFactory.newClient();

  client.randomNuggetPost({}, {topic:"Risk Taking"}, {})
    .then(function(data)
    {
      console.log("postTakeRiskNugget(): data", data);
      console.log("postTakeRiskNugget(): data.data.", data.data);
      console.log("postTakeRiskNugget(): data.data.message[0]", data.data.message[0]);
      viewDisplayTakeRiskNugget(data.data.message[0]);
    });

  console.log("Leaving postTakeRiskNugget()");
}
...
function viewDisplayTakeRiskNugget(nuggetData)
{
  ...
  console.log("Leaving viewDisplayRandomTakeRiskNugget()");
}
...
/*
  ...
  document.getElementById("invite-description-text-id").style.visibility = "visible";
*/

  document.getElementById("subscribe-heading-id").style.display = "block";
  document.getElementById("subscribe-user-email-input-id").style.display = "block";
  document.getElementById("subscribe-button-id").style.display = "block";
  document.getElementById("invite-description-text-id").style.display = "block";

  document.getElementById("join-heading-text-id").style.display = "none";
  document.getElementById("join-button-id").style.display = "none";
  document.getElementById("join-description-text-id").style.display = "none";
...
/*
  ...
  document.getElementById("invite-description-text-id").style.visibility = "hidden";
...
*/
  document.getElementById("subscribe-heading-id").style.display = "none";
  document.getElementById("subscribe-user-email-input-id").style.display = "none";
  document.getElementById("subscribe-button-id").style.display = "none";
  document.getElementById("invite-description-text-id").style.display = "none";
...
*/
  ...
  document.getElementById("join-heading-text-id").style.display = "block";
  document.getElementById("join-button-id").style.display = "block";
  document.getElementById("join-description-text-id").style.display = "block"; 
